...
SV_WC_Framework_Bootstrap::instance()->register_plugin( '3.1.0', __( 'WooCommerce Social Login', 'woocommerce-social-login' ), __FILE__, 'init_woocommerce_social_login', array( 'minimum_wc_version' => '2.1', 'backwards_compatible' => '3.1.0' ) );
...
/**
 * The WC_Social_Login global object, exists only for backwards compat
 *
 * @deprecated 1.4.0
 * @name $wc_social_login
 * @global WC_Social_Login $GLOBALS['wc_social_login']
 */
$GLOBALS['wc_social_login'] = wc_social_login();
