...
<form class="job_search_form" action="<?php echo get_post_type_archive_link( 'job_listing' ); ?>" method="GET">
	...
	<div class="search_jobs">
		...
		<div class="search_keywords">
            ...
            <input type="text" name="search_keywords" id="search_keywords" placeholder="<?php esc_attr_e( 'Keywords', 'listify' ); ?>" />
		</div>
        ...
        <div class="search_categories">
            ...
            <?php job_manager_dropdown_categories( array( 'taxonomy' => 'job_listing_category', 'hierarchical' => 1, 'show_option_all' => __( 'Any category', 'listify' ), 'name' => 'search_categories', 'orderby' => 'name', 'multiple' => false ) ); ?>
        </div>
